...
public class GreatestNumberOfCandies {
    ...
    public static List<Boolean> kidsWithCandiesSolutionWithStream(int[] candies, int extraCandies) {
    ...
    public static List<Boolean> kidsWithCandiesBestSolution(int[] candies, int extraCandies) {
